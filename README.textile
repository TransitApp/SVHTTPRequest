...
h4. Saving a GET response to disk with a progress Indicator

You can tell SVHTTPRequest to update the progress Indicator for you:
...
Here the progressIndicator is a UIProgressView.
