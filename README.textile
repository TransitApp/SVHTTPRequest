...
All of SVHTTPRequest's methods can also be called on @sharedClient@. In addition, SVHTTPClient allows you to sign all outgoing requests for "basic authentication":http://en.wikipedia.org/wiki/Basic_access_authentication using @setBasicAuthWithUsername:password:@.
